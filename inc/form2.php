	...
	<div class="row-fluid">
		<form action="index.php" method="GET">
			...
			<div class="span12">	
				...
				<div class="span6"><?php echo calculation_stddev($currency_1_id, $currency_2_id, $start_date, $end_date));?></div>
			</div>
			<div class="span12">
				<div class="span6"><?php echo 'XCU/'. get_currency_name($currency_2_id); ?></div>
				<div class="span6"><?php echo calculation_stddev(get_wocu_id(), $currency_2_id, $start_date, $end_date));?></div>
			</div>
			<div class="span12">
